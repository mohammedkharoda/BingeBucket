      ...
      <div className="flex flex-col gap-3">
        {movies?.slice(0, 2).map((movie, i) => (
          <motion.div
            ...
            className="relative overflow-hidden rounded-2xl ring-1 ring-border shadow-card hover:ring-accent/30 hover:shadow-card-hover transition-all duration-300"
