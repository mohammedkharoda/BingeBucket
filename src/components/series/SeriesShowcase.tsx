    ...
    <section className="py-20 px-6 lg:px-16 max-w-site mx-auto">
      <div className="flex items-center justify-between gap-12 flex-col-reverse lg:flex-row">
            ...
            >
              {seriesData?.data?.[rotatingIndex]?.poster_path && (
                <Image
                  ...
                  className="object-cover rounded-2xl shadow-card-hover ring-1 ring-border"
                  loading="lazy"
                  sizes="260px"
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
        >
          <span className="eyebrow">Series Collection</span>
          <h2 className="text-4xl lg:text-5xl font-extrabold text-text leading-tight">
          ...
          <Link
            className="inline-flex items-center gap-2 text-sm font-semibold text-accent hover:text-accent-2 transition-colors w-fit"
            href="/series"
          >
